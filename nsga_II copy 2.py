...
class EVCS_Optimization:
    ...
    def save_optimized_data(self, pareto_front):
        ...
        # Collect all station indices selected in any individual
        ...
        # Subset the EVCS dataset
        optimized_stations = self.evcs_data.iloc[all_selected_indices]

        # Keep only the relevant columns
        optimized_stations = optimized_stations[['station_id', 'latitude', 'longitude', 'num_chargers', 'charger_speed']]

        # Save to CSV
        optimized_stations.to_csv(self.optimized_data_file, index=False)
        print("Optimized data saved to optimized_data.csv")
