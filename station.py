...
with open("Datasets/california_stations.csv", mode="w", newline='', encoding='utf-8') as file:
    writer = csv.writer(file)
    
    # Write the header row to the CSV file
    writer.writerow(["Station Name", "Address", "Status", "Waiting Time", "Type", "Coordinates", "Charging Type", "Power Level (kW)"])
