...
def main():
    ...
    optimized_data_path = os.path.join(current_directory, "Datasets", "optimized_data_with_coverage.csv")
    vehicle_data_path = os.path.join(current_directory, "Datasets", "vehice_data_with_coordinates.csv")
    output_path = os.path.join(current_directory, "Datasets", "optimized_data_with_avg_distance.csv")

    compute_average_distance_per_station(optimized_data_path, vehicle_data_path, output_path)
